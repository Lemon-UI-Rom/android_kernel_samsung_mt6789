...
#ifdef CONFIG_LEMONUI_UNLOCK
struct gpufreq_opp_info g_default_gpu[] = {
	GPUOP(1212000, 90000, 90000, POSDIV_POWER_2, 1875, 0), /*  0 OC: 1212MHz @ 900mV (validated live) */
...
#else
struct gpufreq_opp_info g_default_gpu[] = {
	GPUOP(1003000, 83750, 83750, POSDIV_POWER_2, 1875, 0), /*  0 UV: 1003MHz @ 837mV (validated live) */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  1 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  2 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  3 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  4 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  5 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  6 */
	GPUOP(1003000,	83750, 83750, POSDIV_POWER_2, 1875, 0), /*  7 */
	GPUOP(990000,	83125, 83125, POSDIV_POWER_2, 1875, 0), /*  8 */
	GPUOP(976000,	82500, 82500, POSDIV_POWER_2, 1875, 0), /*  9 */
	GPUOP(962000,	81250, 81250, POSDIV_POWER_2, 1875, 0), /* 10 */
	GPUOP(948000,	80625, 80625, POSDIV_POWER_4, 1875, 0), /* 11 */
	GPUOP(935000,	80000, 80000, POSDIV_POWER_4, 1875, 0), /* 12 */
	GPUOP(921000,	79375, 79375, POSDIV_POWER_4, 1875, 0), /* 13 */
	GPUOP(907000,	78750, 78750, POSDIV_POWER_4, 1875, 0), /* 14 */
	GPUOP(893000,	78125, 78125, POSDIV_POWER_4, 1875, 0), /* 15 */
	GPUOP(880000,	77500, 77500, POSDIV_POWER_4, 1875, 0), /* 16 sign off*/
	GPUOP(868000,	76875, 76875, POSDIV_POWER_4, 1875, 0), /* 17 */
	GPUOP(857000,	76250, 76250, POSDIV_POWER_4, 1875, 0), /* 18 */
	GPUOP(846000,	76250, 76250, POSDIV_POWER_4, 1875, 0), /* 19 */
	GPUOP(835000,	75625, 75625, POSDIV_POWER_4, 1250, 0), /* 20 */
	GPUOP(823000,	75000, 75000, POSDIV_POWER_4, 1250, 0), /* 21 */
	GPUOP(812000,	74375, 74375, POSDIV_POWER_4, 1250, 0), /* 22 */
	GPUOP(801000,	74375, 74375, POSDIV_POWER_4, 1250, 0), /* 23 */
	GPUOP(790000,	73750, 73750, POSDIV_POWER_4, 1250, 0), /* 24 */
	GPUOP(778000,	73125, 73750, POSDIV_POWER_4, 1250, 0), /* 25 */
	GPUOP(767000,	72500, 73750, POSDIV_POWER_4, 1250, 0), /* 26 */
	GPUOP(756000,	71875, 73750, POSDIV_POWER_4, 1250, 0), /* 27 */
	GPUOP(745000,	71250, 73750, POSDIV_POWER_4, 1250, 0), /* 28 */
	GPUOP(733000,	70625, 73750, POSDIV_POWER_4, 1250, 0), /* 29 */
	GPUOP(722000,	70000, 73750, POSDIV_POWER_4, 1250, 0), /* 30 */
	GPUOP(711000,	69375, 73750, POSDIV_POWER_4, 1250, 0), /* 31 */
	GPUOP(700000,	68750, 73750, POSDIV_POWER_4, 1250, 0), /* 32 sign off*/
	GPUOP(674000,	68750, 73750, POSDIV_POWER_4, 1250, 0), /* 33 */
	GPUOP(648000,	68750, 73750, POSDIV_POWER_4, 1250, 0), /* 34 */
	GPUOP(622000,	68125, 73750, POSDIV_POWER_4, 1250, 0), /* 35 */
	GPUOP(596000,	68125, 73750, POSDIV_POWER_4,  625, 0), /* 36 */
	GPUOP(570000,	68125, 73750, POSDIV_POWER_4,  625, 0), /* 37 */
	GPUOP(545000,	67500, 73750, POSDIV_POWER_4,  625, 0), /* 38 */
	GPUOP(519000,	67500, 73750, POSDIV_POWER_4,  625, 0), /* 39 */
	GPUOP(493000,	67500, 73750, POSDIV_POWER_4,  625, 0), /* 40 */
	GPUOP(467000,	66875, 73750, POSDIV_POWER_4,  625, 0), /* 41 */
	GPUOP(441000,	66875, 73750, POSDIV_POWER_4,  625, 0), /* 42 */
	GPUOP(415000,	66875, 73750, POSDIV_POWER_4,  625, 0), /* 43 */
	GPUOP(390000,	66250, 73750, POSDIV_POWER_4,  625, 0), /* 44 sign off*/
};
#endif
